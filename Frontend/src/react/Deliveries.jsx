/* Delivery screens (React port) — one component, filtered by status:
 *   GRN / Purchased / Billed / Cancelled. Reuses the orders data layer. */
...
export default function Deliveries({ status }) {
    ...
    <div style={{ padding: 20 }}>
      <div style={{ background: '#fff', borderRadius: 12, boxShadow: '0 1px 3px rgba(0,0,0,.1)', overflow: 'hidden' }}>
        <div style={{ padding: 14, borderBottom: '1px solid #e2e8f0', display: 'flex', alignItems: 'center', gap: 12 }}>
          <input value={q} onChange={(e) => setQ(e.target.value)} placeholder="Search DON / customer / product / supplier…"
          ...
          <div style={{ overflowX: 'auto' }}>
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                ...
                {!rows.length && <tr><td colSpan={8} style={{ ...td, textAlign: 'center', color: '#94a3b8', padding: 32 }}>Nothing here.</td></tr>}
              </tbody>
            </table>
